...
export default function ErrorPage() {
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-background dark:bg-dark-bg dark:bg-[#090e0c] p-6 transition-colors duration-300">
      ...
      <div className="w-full max-w-md">
        <Card className="border-slate-200 dark:border-white/10/70 shadow-xl bg-white dark:bg-dark-surface/80 dark:bg-[#0d1310] dark:border-white/5">
          <CardContent className="pt-8 pb-8 text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 dark:text-slate-400 leading-relaxed max-w-xs mx-auto">
